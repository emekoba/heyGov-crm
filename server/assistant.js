...
function findContact(contacts, identifier) {
...
export async function parseAssistantQuery(query, contacts) {
...
export async function executeAction(parsedAction, contacts, nextId) {
